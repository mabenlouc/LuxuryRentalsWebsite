...
?>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: black;"><span class="glyphicon glyphicon-ok-circle"></span> Car Returned</h1>
        </div>
    </div>
    <br>

    <h2 class="text-center"> Thank you for visiting Luxury Rentals! </h2>
    ...
    <div class="container">
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                <h3 style="color: black;">Your booking has been received and placed into our order processing system.</h3>
                <br>
                ...
                <br>
                <h3 style="color: black;">Reciept</h3>
                <br>
            </div>
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                <h4> <strong>Make & Model: </strong> <?php echo $car_name;?></h4>
                <br>
                <h4> <strong>Plate Number:</strong> <?php echo $car_nameplate; ?></h4>
                <br>
        ...
        <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6>Warning! Reloading the page will cause the above display will be lost. If you want a hardcopy of this page, please print it now.</h6>
        </div>
    </div>
