...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <div ng-switch-default>
                ...
                <!-- </div>    -->
                    ...
                    <!-- <div class="form-group"> -->
                <h5>Fare: <b><?php echo("$ " . $ac_price . "/mi and $ " . $ac_price_per_day . "/day");?></b><h5>    
                <!-- </div>    -->
                     </div>
                     <div ng-switch-when="non_ac">
                     <!-- <div class="form-group"> -->
                <h5>Fare: <b><?php echo("$ " . $non_ac_price . "/mi and $ " . $non_ac_price_per_day . "/day");?></b><h5>    
                <!-- </div>   -->
                     </div>
        </div>

         <h5> Charge type:  &nbsp;
            <input onclick="reveal()" type="radio" name="radio1" value="mi"><b> per mi</b> &nbsp;
      ...
      <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6><strong>Warning!</strong> You will be charged with extra <span class="text-danger">$70</span> for each day after the due date ends.</h6>
        </div>
    </div>
