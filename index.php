                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black">Luxury Rentals</h1>
                            <p class="intro-text">
...
<br>
        <section class="menu-content">
            ...
            <h6> Price with AC: <?php echo ("$" . $ac_price . "/mi & $" . $ac_price_per_day . "/day"); ?></h6>
            <h6> Price without AC: <?php echo ("$" . $non_ac_price . "/mi & $" . $non_ac_price_per_day . "/day"); ?></h6>
...
<h1> No cars available :( </h1>
    ...
    <script>
        function myMap() {
            myCenter = new google.maps.LatLng(42.2411, 83.6130);
            var mapOptions = {
                center: myCenter,
                zoom: 12,
                scrollwheel: true,
