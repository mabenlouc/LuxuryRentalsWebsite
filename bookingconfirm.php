...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: black;"><span class="glyphicon glyphicon-ok-circle"></span> Booking Confirmed</h1>
        </div>
    </div>
    <br>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                <?php } else {
                    ?>
                    <h4> <strong>Price:</strong> $ <?php echo $fare; ?>/mi</h4>
        ...
        <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6>Warning! Reloading this page will cause the above display will be lost.</h6>
        </div>
    </div>
</body>
<?php } else { ?>
